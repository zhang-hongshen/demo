export const sampleResult = {
  ...
  assignmentReview: {
    score: '86',
    level: '良好',
    strengths: ['三类遍历序列整体完整', '能主动写出递归结束条件', '表达顺序清晰'],
    issues: ['后序遍历解释偏简略', '递归调用过程没有展开到左右子树层级'],
    rubric: [
      { criterion: '遍历序列', score: '55/60', comment: '前序、中序、后序序列基本正确。' },
      { criterion: '递归过程解释', score: '23/30', comment: '说明了空节点边界，但调用顺序展开不足。' },
      { criterion: '书写规范', score: '8/10', comment: '格式清楚，个别符号可更统一。' }
    ],
    feedback: '你已经掌握遍历顺序，下一步要把递归调用过程讲清楚，特别是左右子树返回到根节点的时机。',
    improvementTasks: ['补画一次递归调用栈', '用同一棵树重写后序遍历解释', '完成一道含空子树的补充题']
  },
